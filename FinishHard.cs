...
{
    public partial class FinishHard : Form
    {
        public FinishHard()
        {
            InitializeComponent();
        ...
        private void FinishHard_Load(object sender, EventArgs e)
        {
            int finishResult = HardLevelTest.result + HardLevelGrammar.result + HardLevelAudio.result;
            ...
            HardLevelTest.result = 0;
            HardLevelGrammar.result = 0;
            HardLevelTest.result = 0;
        }
